...
var ClientService = /** @class */ (function () {
    function ClientService(clientConfig) {
        if (String(clientConfig) === '[object Object]' && clientConfig.username && clientConfig.apiKey) {
            ...
            this.authService = new AuthService_1.AuthService(this.ethAddress);
            ...
            var ethAddress = arguments[0], password = arguments[1], _a = arguments[2], toolName = _a === void 0 ? 'MythXJS' : _a, _b = arguments[3], environment = _b === void 0 ? 'https://api.mythx.io/v1' : _b, accessToken = arguments[4];
