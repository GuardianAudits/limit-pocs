...
interface LimitPoolModifiersInterface extends ethers.utils.Interface {
  functions: {
...
export class LimitPoolModifiers extends BaseContract {
  ...
  interface: LimitPoolModifiersInterface;
