...
interface LimitPoolFactoryStorageInterface extends ethers.utils.Interface {
  functions: {
...
export class LimitPoolFactoryStorage extends BaseContract {
  ...
  interface: LimitPoolFactoryStorageInterface;
